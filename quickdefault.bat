...
copy /Y C:\Users\halff\Documents\.scriptbat\quicksrt=-ass.bat %CD%\quicksrt=-ass.bat
copy /Y C:\Users\halff\Documents\.scriptbat\subsdelay.bat %CD%\subsdelay.bat
copy /Y C:\Users\halff\Documents\.scriptbat\quickdefault.bat %CD%\quickdefault.bat
...
for %%f in (*.mkv) do (
		...
		if %track% EQU -1 ( 
			...
			C:\Users\halff\Documents\.bat\mkvmerge.exe -o "%%f.mkv" --atracks %track% "%%f"
			rem C:\Users\halff\Documents\.bat\mkvmerge.exe -o "%%f.mkv" --default-track %track%:yes "%%f"
